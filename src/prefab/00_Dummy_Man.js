...
class Dummy_Man extends Phaser.GameObjects.Sprite {

    constructor(scene, x, y, texture, state = 'default_still', frame) {

        console.log("from 00_Dummy_Man.js: constructing...");
        ...
        // physics variables
            ...
            this.myPhysics = {
                ...
                default_still: {acceleration: 500, max_x_vel: 500, max_y_vel: 500, ground_drag: 500},
