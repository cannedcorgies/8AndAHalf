////////////////
//
// this scene is meant to explore both
//  guido's self-isolation in the face
//  of his problems and his narcissistic
//  ownership of the world which eventually
//  backfires
//
//  prefabs
//  - center
...
class Scene2 extends Phaser.Scene {
    ...
    create() { 
        ...
        this.presence.alpha = 0;
            // NOTE ON PRESENCE
            //  - radius to allow woman npc to detect and start following guido
    ...
    update() {
        ...
        // just move the player along
        this.box.update();
        this.guido.update();
        this.presenceUpdate();

        // move women if they've detected guido
    ...
    // i want the player to be sent to the next scene after a short time post-collision
